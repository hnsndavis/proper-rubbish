...
const s = {
  ...
  script: { fontFamily: 'var(--font-script)', fontSize: 'clamp(18px,5vw,56px)', lineHeight: 0.95, color: 'var(--red-500)', marginBottom: 'clamp(8px,1.4vw,16px)' },
  ribbonRow: { display: 'flex', justifyContent: 'center', marginBottom: 'clamp(26px,3.6vw,40px)' },
  ribbon: { fontSize: 'clamp(14px,7.5vw,104px)' },
